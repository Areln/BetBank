...
namespace BetBank.Controllers
{
    public class UserDataController : Controller
    {
        ...
        public UserDataController(BetBankDbContext context)
        {
            _context = context;

        }
        public IActionResult CalculateUserROI(string userId)  
        {
            //_ROI.GetUserData(userId);
           GetIntitialInvestment(_context.UserData.Find(1));
